        ...
        <div className={`content ${isActiveMenu ? 'opacity' : ''}`}>
          <div className="notification">
            <p>
              ...
              <span>
                If you change your current email address, a check will be run to see if such email
                is registered with the retailer.
              </span>
            </p>
            <p>
              <i className="solid circle-check"></i>
                    ...
                    <div className="checkbox-item">
                      ...
                      <div className="form-note">
                        ...
                        <i>
                          ...
                          attention that the max length of product name for youe store is 255
                          symbols and product name can be cut.)
                        </i>
                      </div>
                    </div>
                  </div>
